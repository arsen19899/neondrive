...
data class LauncherSettings(
    ...
    /**
     * Голосовые команды вообще. Выключение гасит и кнопку руля, и микрофон в
     * поиске адреса — один тумблер на всю функцию.
     */
    val voiceEnabled: Boolean = true,
    /**
     * Ждать обращение «Елисей» с постоянно открытым микрофоном.
     *
     * Выключено по умолчанию сознательно, и это не осторожность ради
     * осторожности. Постоянно открытый микрофон — решение, которое принимает
     * владелец машины, а не разработчик за него; к тому же работает такое
     * ожидание только на офлайн-движке (см. com.neondrive.launcher.voice.VoskEngine),
     * а модель распознавания надо сначала положить на устройство. Кнопка руля и
     * кнопка микрофона в поиске работают без этого тумблера.
     */
